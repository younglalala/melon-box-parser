...
test2_lable='/Users/wywy/Desktop/test2_lable01'
test2_filename = './ok_test2_cls.tfrecords'  # 输出文件地址
...
def test2_shuffle_batch(train_file_path, image_size,batch_size, capacity=700, num_threads=3):
...
if __name__=='__main__':
    saver_lables(test2_lable,test2_filename)
    a=test2_shuffle_batch(test2_filename,[18,88,3],100)
