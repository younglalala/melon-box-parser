...
test_img_path = '/Users/wywy/Desktop/客观题数据/data/ok_img/test_img/test_cls'
test_filename = './cls_test.tfrecords'  # 输出文件地址
...
if __name__=='__main__':
    saver_lables(test_img_path,test_filename)
    # read_data_for_file(train_filename,100,[16,88,3])
    a=test_shuffle_batch(test_filename,[16,168,3],1000)
