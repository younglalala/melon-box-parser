...
img_path="/Users/wywy/Desktop/训练完成模型/客观题数据（单、多选）/train1_img_"
...
if __name__=='__main__':
    ...
    saver_lables(img_path,train_filename)
    # read_data_for_file(train_filename,100,[16,168,3])
    a=train_shuffle_batch(train_filename,[16,168,3],100)
    with tf.Session() as sess:
        ...
        print(cc[0])
        print(bb[0])
        index=np.where(bb[0]>0.9)[0]
        print(type(index.tolist()))
