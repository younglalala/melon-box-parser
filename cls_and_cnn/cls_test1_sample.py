...
test1_lable='/Users/wywy/Desktop/test1_lable01'
test1_filename = './ok_test1_cls.tfrecords'  # 输出文件地址
...
def test1_shuffle_batch(train_file_path, image_size,batch_size, capacity=700, num_threads=3):
...
if __name__=='__main__':
    # saver_lables(test1_lable,test1_filename)
    a=test1_shuffle_batch(test1_filename,[18,88,3],100)
