...
lable_all='/Users/wywy/Desktop/test_lable'
test_filename = './test1_cls.tfrecords'  # 输出文件地址


def saver_lables(lable_all,tets_filename):
...
def test_shuffle_batch(train_file_path, image_size,batch_size=50, capacity=700, num_threads=3):
...
if __name__=='__main__':
    saver_lables(lable_all,test_filename)
    a=test_shuffle_batch(test_filename,[18,88,3])
