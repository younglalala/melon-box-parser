...
test_path="/Users/wywy/Desktop/训练完成模型/客观题数据（单、多选）/test1_img"
test_filename = './cnn0_test.tfrecords'
...
if __name__=='__main__':
    ...
    a=test_shuffle_batch(test_filename,[16,168,1],100)
